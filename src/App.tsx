...
export function App() {
    ...
    const addYarn = () => {
        setYarns([...yarns, { id: crypto.randomUUID(), totalWeight: "", totalCost: "", usedWeight: "" }]);
    };
    ...
    const totalCost = yarns.reduce((sum, yarn) => sum + calculateYarnCost(yarn), 0);
          ...
          <div className="container mx-auto px-4 py-8 max-w-7xl">
              <div className="text-center mb-8">
                  <div className="flex items-center justify-center gap-3 mb-3">
                      ...
                      <h1 className="text-4xl font-bold text-foreground">Calculadora de Preço de Crochê</h1>
                  </div>
                  <p className="text-muted-foreground">Calcule o preço perfeito para suas criações artesanais</p>
              </div>

              <div className="grid lg:grid-cols-3 gap-6">
                  <div className="lg:col-span-2 space-y-4">
                      <div className="flex items-center justify-between mb-4">
                          <h2 className="text-2xl font-semibold text-foreground">Detalhes dos Fios</h2>
                      ...
                      <div className="mt-6 p-4 bg-card border border-border rounded-lg">
                          <Label htmlFor="margin" className="text-base font-medium text-foreground">
                              Margem de Lucro (%)
                          </Label>
                          <Input
                              id="margin"
